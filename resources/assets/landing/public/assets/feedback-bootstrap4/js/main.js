...
$(function(){
    ...
    $.ajax({
      ...
      success: function(data){
        ...
        if(data.result==="success"){
          $.jGrowl('Сообщение успешно отправлено!', {theme: 'jgrowl-success', life: 10000});
  ...
  var formStravita = new ProcessForm({idForm: 'feedbackStravita'});
  formStravita.init();

  var formAutokasko = new ProcessForm({idForm: 'feedbackAutokasko'});
  formAutokasko.init();

  var formProperty = new ProcessForm({idForm: 'feedbackProperty'});
  formProperty.init();

  var formTourism = new ProcessForm({idForm: 'feedbackTourism'});
  formTourism.init();
